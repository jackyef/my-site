...
the things that I learned during my very first remote job search, which hopefully could be useful
to people who are looking to start looking for remote jobs as well.
...
remote job might not be a good fit for you. Here is my opinion about the advantages and disadvantages of working remotely.
...
- **Compensation**
  ...
  **_might_**, because every company handles this differently.
...
- **Less benefits**
  ...
  Also, if you are working in Indonesia, you usually get yearly bonus. Not all companies provide this, so you would ask them about that and 
...
as [@remote_dev_jobs](https://twitter.com/remote_dev_jobs). Some people in your area of interest might also tweet/retweet about job opportunities as well.
As an example, I found quite a few remote job opportunities from [this particular tweet of someone looking for job](https://twitter.com/carolstran/status/1290187102060023808).
...
the exercises everyday, even 1-2 a day is good enough in the long run. This will normally only take around 1 hour everyday. Not all commpanies ask algorithm
...
so being able to converse in English effectively is almost non-negotiable. Written communications also happen a lot especially with teams in different timezones.
As such, being able to read and write will take you a long way!
...
technical documentations and blog posts are great for this. For writing, writing documentations and blog posts can be helpful as well.
Listening can be improved by watching videos or even your favorite TV shows or movies. In my opinion, speaking is the hardest one to improve simply because
...
in addition to the portfolio you list down in your resume, you should also try publish some stuffs you have worked on before. Try to think of a problem, no
matter how small it is and then try to create a solution for it. To give you a real example, I wrote [Bundlewatch GH Action](https://github.com/jackyef/bundlewatch-gh-action)
...
the process and you show that publicly! I personally have received positive remarks from some interviewers who saw that I have some experiences with the
tech stack they are using.
...
initially but has since started to write on my own blog. I really appreciate [@alfrcr](https://github.com/alfrcr) for encouraging me to start writing early
in my career. He was the one to encourage me and say that it doesn't matter if I think the topic I am writing about isn't interesting enough. There will
always be some people, no matter how few, that will learn from the things you write! Writing articles is also a very effective form of exercise that will help improve your writing skills!
...
to each company](https://www.themuse.com/advice/this-is-the-cover-letter-advice-everyone-misunderstands). Avoid lengthy resume. Instead, try to only list
relevant information in your resume for the job you are applying for. For example, the company probably
doesn't care if you ranked first in a basketball tournament back in college. Show that you have done your research and
you are not just applying wherever you can. Most companies require you to fill their application form to apply for the job. Some might require you to just
...
1. Initial interview
   ...
   matching expectations before proceeding further. There are many different way to approach this question. One idea is if you haven't done research about
   the salary, you can try asking them about the market rate for people with your skillset.
...
3. Final interview
   ...
   The goal of the final interview is usually to make sure you are a good fit for the company. The questions here will revolve more around your soft skills
   and past (non-technical) experiences. Companies usually look for people that hold similar values to them. I would say as long as your are not a jerk,
...
2. Could you tell me about the leave policy in &lt;Company X&gt;?
...
about their 1-year plan, or how much runway they have. You might also want to ask them about their tech stacks or toolings that they use.

## Don't beat yourself up 💪

You probably aren't going to get the job on your first try and that is totally fine! Don't beat yourself up because of it! I applied to a lot of companies
before finally getting 3 offers in August 2020. I started my search casually in the beginning of 2020, and got no offers at all up to that point.
...
Do you have anything you want to ask about working remotely? 
Do you have advices for people like me who are new to remote working? 
Send me a [tweet](https://jackyef.com), 
