...
export const meta = {
  ...
  authors: [jackyef],
  image: createOgImageUrl({ title: 'Building a Blog with Next + Preact + Tailwind' }),
...
with new tools or building new stuff when I feel like to do so. When I wanted to try something out, I found 
...
stuff that I want to achieve after the rewrite, they are:

1. Being able to make changes and add stuff easily
2. A lightweight CSS solution
3. A blog

### Being able to make changes and add stuff easily
...
a lot of stuff that I can play with on this playground! 
