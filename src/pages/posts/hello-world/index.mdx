...
export const meta = {
  ...
  authors: [jackyef],
  image: createOgImageUrl({ title: 'Building a Blog with Next.js + Preact + Tailwind' }),
...
I ended up going with Next.js + Preact combo part. 
...
I feel more productive with `emotion` APIs compared to `styled-components`, but it always bothered me 
