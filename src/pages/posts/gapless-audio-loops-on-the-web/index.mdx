...
allows our web-app to integrate to the operating system in a nicer way. For instance, when Tranquil is running on an
Android device, it will show up in the notification tray and users can play/pause from there.
...
The Web Audio API in particular is still a very unknown thing for me.
