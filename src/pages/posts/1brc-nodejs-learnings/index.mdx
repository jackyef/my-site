...
<a href="/assets/blog/1brc-nodejs-learnings/fg-1.png" target="_blank" rel="noopener noreferrer" className="block w-full not-prose">
  <img loading="lazy" src="/assets/blog/1brc-nodejs-learnings/fg-1.png" alt="Flamegraph for baseline implementation" className="object-contain" />
</a>
...
<a href="/assets/blog/1brc-nodejs-learnings/fg-2.png" target="_blank" rel="noopener noreferrer" className="block w-full not-prose">
  <img loading="lazy" src="/assets/blog/1brc-nodejs-learnings/fg-2.png" alt="Flamegraph for baseline implementation" className="object-contain" />
</a>
