---
title: 1-billion row challenge (1BRC) with Node.js
description:
...
[1-billion row challenge](https://1brc.dev/) is a challenge to process a 12GB file containing 1-billion rows of text. 
...
<Table>
  ...
  <Table.TBody>
    ...
    <Table.Tr>
      <Table.Td>Work with bytes, not strings</Table.Td>
      <Table.Td>2m35s</Table.Td>
      <Table.Td>2.2x</Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>Specialized number conversion</Table.Td>
      <Table.Td>1m44s</Table.Td>
      <Table.Td>3.3x</Table.Td>
    </Table.Tr>
    <Table.Tr>
      <Table.Td>Parallelization, 14 cores (10P/4E)</Table.Td>
