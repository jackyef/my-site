...
const baseButtonClasses =
  'opacity-0 md:opacity-100 flex items-center content-center absolute bg-surface-3 w-12 h-12 rounded-full border-none shadow-md z-10 items-center justify-center font-bold text-3xl';
